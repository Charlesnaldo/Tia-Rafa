      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-gray-600 text-lg font-bold leading-relaxed max-w-sm">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-gray-800 font-black text-xl mb-8 flex items-center gap-2">
          ...
          <div className="lg:col-span-3">
             <div className="bg-white/60 p-7 rounded-[3rem] border-2 border-white shadow-2xl shadow-purple-100/40 backdrop-blur-md">
                <h4 className="text-gray-800 font-black text-xl mb-6">Dúvidas? 👋</h4>
                <div className="space-y-4">
                  <a href="mailto:sac@tiarafa.com.br" className="flex items-center gap-3 p-4 bg-purple-50/50 rounded-[1.8rem] border-2 border-transparent hover:border-purple-100 transition-all group">
                  ...
                  <a href="#" className="flex items-center gap-3 p-4 bg-green-50/50 rounded-[1.8rem] border-2 border-transparent hover:border-green-100 transition-all group">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-[3rem] p-8 border-2 border-pink-50 shadow-xl shadow-pink-100/30 relative">
              <div className="bg-pink-400 w-14 h-14 rounded-[1.5rem] flex items-center justify-center mb-5 shadow-lg shadow-pink-200">
