...
const AtividadesPage: React.FC = () => {
  const activities = [
    {
      ...
      downloadLink: '/materiais/alfabetização.pdf',
    },
    {
      id: 2,
      title: 'Boas Vindas - Educação Infantil',
      description: 'Atividade lúdica para receber os alunos no início do ano letivo.',
      downloadLink: '/materiais/Boas Vindas.pdf',
    },
    {
      id: 3,
      title: 'Contando Histórias na Páscoa',
      description:
        'Sequência didática sobre a história da Páscoa para ensino fundamental.',
  ...
  return (
    <main className="container mx-auto px-4 py-8 md:mt-[380px]">
      <h1 className="text-4xl font-bold text-center mb-10">
        Atividades Gratuitas para Download
      </h1>
